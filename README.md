...
- **[`sql/`](./data-analysis-ml-stats/sql)**
  - [SQL Ecommerce Analysis](./data-analysis-ml-stats/sql/olist-ecommerce-sql-analysis) — Cohort retention, RFM segmentation, delivery-lateness impact on churn, MoM growth trends, and review-score vs. churn analysis on the Olist Brazilian E-Commerce dataset.
